export function SiteFooter() {
  return (
    <footer className="mt-32 bg-sage-ink text-background/80">
      <div className="max-w-canvas mx-auto px-12 py-20 grid grid-cols-1 md:grid-cols-12 gap-12">
        <div className="md:col-span-4">
          ...
          <div className="mt-8 text-[10px] tracking-[0.2em] text-background/60">
            © 2026 FULLTY · 프로토타입
          </div>
        </div>

        <div className="md:col-span-2">
          <div className="text-[10px] tracking-[0.2em] text-background/60 mb-4">SHOP</div>
        ...
        <div className="md:col-span-2">
          <div className="text-[10px] tracking-[0.2em] text-background/60 mb-4">SUPPORT</div>
          <ul className="space-y-2.5 text-xs">
            <li>공지사항</li>
            <li>FAQ</li>
            <li>1:1 문의</li>
        ...
        <div className="md:col-span-2">
          <div className="text-[10px] tracking-[0.2em] text-background/60 mb-4">ABOUT</div>
          <ul className="space-y-2.5 text-xs">
            <li>회사 소개</li>
            <li>이용약관</li>
            <li>개인정보처리방침</li>
        ...
        <div className="md:col-span-2">
          <div className="text-[10px] tracking-[0.2em] text-background/60 mb-4">JOURNAL</div>

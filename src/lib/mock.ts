...
export type InspectionStatus = "풀티 도착 대기" | "검수 중" | "승인" | "반려";
...
export type Proposal = {
  ...
  // 개인 셀러: 풀티 검수 결과
  inspection?: { status: InspectionStatus; note?: string; date?: string };
  // 개인 셀러: 풀티→구매자 운송장 (승인 후)

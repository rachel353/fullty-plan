  ...
  if (step === "done") {
    return (
      <div className="py-20 flex flex-col items-center gap-4 text-center">
        ...
        <div className="text-lg font-semibold">발송 정보가 등록되었습니다</div>
        <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
          구매자에게 배송 정보가 전달되었습니다.<br />
          배송 완료 후 정산이 진행됩니다.
        </p>
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div className="border-b border-border pb-4">
        ...
        <h2 className="text-xl font-bold">거래 진행</h2>
        <p className="text-sm text-muted-foreground mt-1">상품을 풀티 물류센터로 발송하고 운송 정보를 등록하세요.</p>
      </div>

      {/* 진행 단계 */}
      <div className="flex items-center gap-0">
        {["거래 확정", "발송 정보 입력", "배송 완료 · 정산"].map((label, i) => (
      ...
      {/* 발송 안내 */}
      <div className="border border-border bg-muted/10 px-4 py-3 text-[11px] text-muted-foreground leading-relaxed space-y-1">
        <div className="font-medium text-foreground text-xs mb-1">풀티 물류센터 발송 안내</div>
        <div>주소: 서울특별시 강남구 테헤란로 123, 풀티 물류센터</div>
        <div>수령인: 풀티 입고팀 · 02-1234-5678</div>

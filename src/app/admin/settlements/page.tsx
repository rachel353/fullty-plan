...
const rows = [
  { id: "ad001", seller: "빈티지 웍스", type: "판매", amount: 1088000, period: "2026-03", status: "지급 완료" as const },
  { id: "ad002", seller: "오브제 스튜디오", type: "렌탈", amount: 722500, period: "2026-03", status: "정산 확정" as const },
    ...
    <div className="space-y-6">
      <div className="border-b border-border pb-4">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          판매 / 렌탈 / 위탁 정산 내역 및 지급 상태 관리 (매월 15일)
        </p>
      </div>

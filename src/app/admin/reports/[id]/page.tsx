...
const REPORTS: Report[] = [
  {
    ...
    targetId: "rv041",
    reason: "허위 / 조작 리뷰 의심",
    detail: "동일 제품에 대해 같은 계정이 짧은 기간 내 리뷰를 재작성하고, 이전 리뷰 삭제 후 평점만 높인 내용으로 대체한 정황이 있음. 작성 패턴이 일반 구매 후기와 다르게 과도하게 정제된 표현을 사용함.",
  ...
  },
  {
    ...
    targetId: "ar018",
    reason: "광고성 콘텐츠",
    detail: "정보글 형식을 띠고 있으나 특정 외부 쇼핑몰 및 브랜드를 반복적으로 언급하며 링크를 첨부함. 풀티 입점 상품이 아닌 타 플랫폼 상품으로 유도하는 광고성 글로 판단됨.",
    reporter: "park@gmail.com",
    reporterType: "구매자",
    date: "2026-04-19",
    status: "조치 완료",
    actionType: "콘텐츠 삭제",
    actionNote: "광고성 외부 링크 포함 확인. 해당 정보글 삭제 및 작성자 경고 조치.",
  ...
  },
  {
    ...
    detail: "정보글 본문 하단에 피싱 의심 URL이 포함되어 있음. 클릭 시 외부 사이트로 이동되며, 개인정보 수집 가능성이 있는 페이지로 연결됨.",

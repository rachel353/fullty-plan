...
description: Generate design system rules and CSS from base tokens. Reads index.css to extract colors, typography, and spacing tokens, then maps them to semantic UI states (info/action/success/warning/danger/frozen). Outputs .Codex/rules/design_system_rules.mdc and app/globals.css.
---
...
```bash
python .Codex/skills/design-system-builder/scripts/generate_design_system.py
```

### Option 2: Codex가 수동으로 생성
1. `index.css` 읽기
...
### 1. `.Codex/rules/design_system_rules.mdc`

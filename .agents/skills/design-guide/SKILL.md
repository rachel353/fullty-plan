...
```bash
cd /Users/tchen/projects/mycode/Codex-skills/design-guide
```
...
3. **Codex Reviews Output**: Reads design-guide.md

4. **Codex Presents Findings**:
...
6. **Codex Implements**: Uses extracted design tokens to build pixel-perfect HTML/CSS
...
## Advanced: Codex-Driven Analysis

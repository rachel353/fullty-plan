...
description: Guide for creating Codex slash commands. Use when the user wants to create a new slash command, update an existing slash command, or asks about slash command syntax, frontmatter options, or best practices.
---

# Slash Command Creator

Create custom slash commands for Codex to automate frequently-used prompts.
...
| Scope    | Path                    | Shown as           |
|----------|-------------------------|-------------------|
| Project  | `.Codex/commands/`     | (project)         |
| Personal | `~/.Codex/commands/`   | (user)            |

### Namespacing

Organize commands in subdirectories:
- `.Codex/commands/frontend/component.md` → `/component` shows "(project:frontend)"
- `~/.Codex/commands/backend/api.md` → `/api` shows "(user:backend)"
...
5. **Test**: Run the command in Codex
